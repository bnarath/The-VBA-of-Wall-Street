...
'Iterate through worksheets and activate each worksheet one after the other.
    ...
    For Each ws In ThisWorkbook.Worksheets
        ...
        While Row_Index <= Last_Row
            ...
            Last_Instance = Range(Cells(Row_Index, 1), Cells(Last_Row, 1)).Find(What:=Ticker, _
                                                LookAt:=xlWhole, _
                                                LookIn:=xlValues, _
            ...
            Yearly_Change = Cells(Last_Instance, 6).Value - Cells(Row_Index, 3).Value
            ...
            Else
                Percent_Change = Yearly_Change / Cells(Row_Index, 3).Value
            End If
