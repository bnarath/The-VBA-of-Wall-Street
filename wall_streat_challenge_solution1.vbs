...
' Output: Aggregate Array(Unique, D1, OV, D2, CV, CUMSUM)
 'Author: Bincy Narath
...
Sub Stock_Analysis()
    ...
    'Declarations
    Dim ws As Worksheet, Data(), TotalRows As Long, ErrCount As Long, TotalColumns As Integer, PercChange As Double, AGG(), Ticker(0 To 2) As String, Value(0 To 2) As Double
    ...
    For Each ws In ThisWorkbook.Worksheets
        ...
        For i = LBound(Unique) To UBound(Unique) - 1 '-1 because the Output of GetAgg has an empty place at the end for all variables
            ...
            Else 'I consider no change in stock also is bad, hence red for 0%
            ...
            Else
                PercChange = (AGG(4)(i) - AGG(2)(i)) / AGG(2)(i) '(CV-OV)/OV -> Need be formatted as percentage later
            End If
